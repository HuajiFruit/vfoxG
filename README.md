...
Special thanks to the [vfox](https://github.com/version-fox/vfox) project (Apache License 2.0, Copyright Han Li and contributors) for providing the excellent cross-platform version management engine. vfoxG is built on top of vfox's capabilities and bundles it in unmodified binary form.

特别感谢 [vfox](https://github.com/version-fox/vfox) 项目（Apache License 2.0，版权归 Han Li 及贡献者所有）提供了优秀的跨平台版本管理引擎。vfoxG 基于 vfox 的能力构建，并以未修改的二进制形式包含 vfox。
