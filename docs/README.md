...
This directory contains the project-level documentation for vfoxG. Keep the Chinese and English versions aligned when changing architecture, workflow, or coding rules.
...
| [RELEASE.md](RELEASE.md) | Release assets, tag workflow, Windows installer process, and checklist. |
